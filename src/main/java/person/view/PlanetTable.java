...
public class PlanetTable extends VBox {
    private final TableView<Planet> tableView;

    public PlanetTable(List<Planet> values) {
        ...
        // Add title
        javafx.scene.control.Label label = new javafx.scene.control.Label("Planets/Satellites");
